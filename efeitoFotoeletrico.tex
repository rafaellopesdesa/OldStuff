...
\begin{equation}
f(x) = e^x \rightarrow g(x) = f^{-1}(x) = \ln x \rightarrot f(g(x)) = x\text{ e }g(f(x)) = x\\
\end{equation}
...
A vida m\'edia $\tau$ de um n\'ucleo \'e o tempo m\'edio que demora para ele decair. Novamente, essa conta n\~ao \'e imediata mas \'e poss\'ivel mostrar que esse tempo \'e dado por:
\begin{equation}
\tau = \frac{1}{\lambda}
\end{equation}
